...
elseif locale == "zhTW" then --Taiwan is a part of China forever
    ...
    L["SPELLWHISPER_TEXT_STOPFOLLOW_MANUALLY"] = "你已停止跟隨。"
    --法術技能失敗原因
    L["ABSORB"] = "吸收"
    L["BLOCK"] = "格擋"
    L["DEFLECT"] = "偏斜"
    ...
    L["|cFFBA55D3SpellWhisper|r v%s is |cFFFF4C00Out of date|r. Goto %s for |cFFF48CBANew Version.|r"] = "|cFFBA55D3技能通報|r v%s已|cFFFF4C00過期|r，請用|cFF00FFFF桃樂豆|r|cFFFFF468更新|r或前往%s|cFFFFF468下載|r|cFFF48CBA最新版本|r。"
    L["<|cFFBA55D3SW|r>Start Check Team Member's |cFFBA55D3SpellWhisper|r Version."] = "<|cFFBA55D3SW|r>開始檢查團隊成員技能通報插件版本。"
    L["<|cFFBA55D3SW|r>Don't Have Any Team Member(s)."] = "<|cFFBA55D3SW|r>不在一個隊伍或團隊中。"
    L["<|cFFBA55D3SW|r>Can't Check |cFFBA55D3SpellWhisper|r Version In Battleground."] = "<|cFFBA55D3SW|r>無法在戰場中檢查技能通報版本。"
    L["<|cFFBA55D3SW|r>Please Enable |cFFBA55D3SpellWhisper|r First."] = "<|cFFBA55D3SW|r>請先啟用|cFFBA55D3技能通報|r插件。"
    --Slash Command提示文字
    L["<|cFFBA55D3SW|r>Can NOT Open |cFFBA55D3SpellWhisper|r GUI when you in COMBAT."] = "<|cFFBA55D3SW|r>戰鬥中無法打開|cFFBA55D3技能通報|r設定選項。"
    L["|cFFBA55D3SpellWhisper|r Delay Command Tips:Use |cFF00BFFF/spellwhisper|r |cFFFF0000in|r |cFFCCA4E3[Seconds] [Task]|r or |cFF00BFFF/sw|r |cFFCCA4E3in [Seconds] [Task]|r create a Delay Task."] = "|cFFBA55D3技能通報|r使用說明：使用|cFF00BFFF/spellwhisper|r |cFFFF0000in|r |cFFCCA4E3[Seconds] [Task]|r或者|cFF00BFFF/sw|r |cFFCCA4E3in [Seconds] [Task]|r新建延時任務。"
    ...
    L["|cFFBA55D3SpellWhisper|r Delay Command Tips: Please Input |cFF00E09EValid|r |cFFCCA4E3[Seconds]|r and |cFF00E09ELegal|r |cFFCCA4E3[Command]|r!"] = "|cFFBA55D3技能通報|r使用說明：請輸入|cFF00E09E有效|r的|cFFCCA4E3[Seconds]|r和|cFF00E09E合法|r的|cFFCCA4E3[Command]！"
    ...
    L["Check & Display Version"] = "檢查插件版本"
    L["Enable |cFFBA55D3SpellWhisper|r"] = "啟用|cFFBA55D3技能通報|r"
    ...
    L["Channel: "] = "輸出頻道："
    L["Threat: "] = "仇恨提示："
    L["Anti Disturbance Time"] = "防重複洗頻"
    L["Anti Break Disturbance Time"] = "防破控洗頻"
    L["Whisper Mode"] = "密語通知"
    L["Enable |cFFFFCC33Whisper|r"] = "啟用|cFFFFCC33密語|r通知"
    L["Enable |cFF44CEF6TOT Whisper|r Warning"] = "啟用|cFF44CEF6同目標密語|r警告"
	...
	L["|cFF00FF00Left Click|r to Unlock/Lock HUD Frame"] = "|cFF00FF00左鍵|r解鎖/鎖定 HUD 框架"
	L["|cFF00FF00Ctrl+Left|r to Rest HUD Frame Pos"] = "|cFF00FF00Ctrl+左鍵|r重置 HUD 框架位置"
	
	-- 自行加入
	L["SpellWhisper"] = "技能通報"
	L["Spell Whisper"] = "技能通報"
end