...
PanelTitle:SetText("|cFFFF6633" .. L["Spell Whisper"] .. "|r" .. " v" .. Addon.Version)
--所有组件表
Panel.Controls = {}
--创建唯一命名函数
local UniqueName
...
function Panel:Initialize()
	...
	local OutputChannelList = self:CreateDropDown(L["Channel: "],
		{"off", L["off"],--[[ "say", L["say"], "yell", L["yell"],]] "instance_chat", L["party"], "raid", L["raid"], "Raid_Warning", L["Raid_Warning"], "self", L["self"], "hud", L["hud"],},
