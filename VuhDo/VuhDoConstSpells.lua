...
VUHDO_SPELL_ID.DIVINE_AEGIS = VUHDO_getSpellInfoSafe(47509);
...
VUHDO_SPELL_ID.ILLUMINATED_HEALING = VUHDO_getSpellInfoSafe(76669);
...
VUHDO_SPELL_ID.BUFF_SHADOW_PROTECTION           = VUHDO_getSpellInfoSafe(27683);
