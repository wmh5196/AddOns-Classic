...
l10n.AutoShowEquipmentFrame_TRUE = "自動顯示裝備";
l10n.AutoShowEquipmentFrame_FALSE = "手動顯示裝備";
l10n.Minimap_TRUE = "顯示小地圖按鈕";
l10n.Minimap_FALSE = "隱藏小地圖按鈕";
l10n.ResizableBorder_TRUE = "拖曳視窗改變大小";
l10n.ResizableBorder_FALSE = "停用拖曳視窗改變大小";
l10n.SetWinStyle_BLZ = "暴雪風格視窗";
l10n.SetWinStyle_ALA = "平面風格視窗";
l10n.SetSingleFrame_TRUE = "顯示單一視窗";
l10n.SetSingleFrame_FALSE = "顯示多個視窗";
l10n.SetStyleAllTo1_ThisWin = "三欄";
l10n.SetStyleAllTo2_ThisWin = "單欄";
l10n.SetStyleAllTo1_AlsoSetShownWin = "三欄";
l10n.SetStyleAllTo1_LaterWin = "三欄";
l10n.SetStyleAllTo2_AlsoSetShownWin = "單欄";
l10n.SetStyleAllTo2_LaterWin = "單欄";
l10n.TalentsInTip_TRUE = "浮動提示資訊中顯示玩家天賦";
l10n.TalentsInTip_FALSE = "不要在浮動提示資訊中顯示玩家天賦";
l10n.TalentsInTipIcon_TRUE = "浮動提示資訊中使用圖示表示天賦樹";
l10n.TalentsInTipIcon_FALSE = "浮動提示資訊中使用文字表示天賦樹";
...
l10n["CANNOT APPLY : ERROR CATA."] = "無法套用天賦: 天賦數據錯誤（浩劫與重生）";
