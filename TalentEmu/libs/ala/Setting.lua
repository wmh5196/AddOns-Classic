...
-->	SettingUI	<--
	...
	local function CreateInterfaceOptionsFrameContainer(SettingUI)
		...
		if InterfaceOptions_AddCategory then 
			...
			local category = Settings.RegisterCanvasLayoutCategory(InterfaceOptionsFrameContainer, InterfaceOptionsFrameContainer.name)
			category.ID = InterfaceOptionsFrameContainer.name
