...
st.shaman.earthenRune = "有兩種方法可以獲得這個。首先是\n在貧瘠之地刷沙漠幻影。掉落率和\n"
			...
			.."掉落率低得多，而且你需要\n殺死第二個刷新的怪物。\n\n去貧瘠之地以獲得勝利！\n\n"
			.."除此之外，它是一個直接掉落\n並學習符文的符文，沒有額外的任務"
st.shaman.galvanicIcon = "前往莫高雷或杜洛塔，尋找\n並聆聽雷擊聲。\n\n"
			.."莫高雷的地點靠近貧瘠之地。\n\n"
			.."跑到一個“被閃電灌注的圖騰”旁，\n點擊並裝備。\n\n"
			.."用閃電箭殺死 10 個怪物。\n\n點擊插槽"
...
st.warlock.grace = "你需要從以下怪物身上獲得一本不祥之書的掉落：提瑞斯法林地的\n"
			.."阿伽曼德磨坊的暗眼骨巫，或者杜洛塔迴音群島的巫毒/被施咒的巨魔 (部落)，\n"
...
st.warlock.graceDM = "還要獲得文地戈血液。文地戈在\n卡拉諾斯下方/以西。狼的顎骨\n"
			...
			.."微光嶺，在那裡你會找到一個召喚\n"
			.."圓圈。召喚並殺死索博茲。恭喜！"
st.warlock.graceDur = "在杜洛塔的一些額外地點，靠近\n奧格瑞瑪，也被標記為不祥之書的\n"
			.."掉落地點。\n\n"
			.."瑪克魯拉腿從沿海灘\n"
			.."遊蕩的螃蟹身上掉落。但是，頭骨在\n"
			.."提拉加德要塞區域。儀式召喚圓圈\n"
...
st.warrior.furiousThunder = "艾爾文森林的霍格 (聯盟/部落)。\n\n"
			...
			.."泰達希爾的納爾普尼藏寶處 (聯盟)\n\n"
			.."杜洛塔的死亡剝皮者，閃電皮怪物；\n"
			.."杜洛塔骷髏岩石洞穴的菲爾織法者斯科恩 (稀有)，加茲烏斯；杜洛塔\n"
...
st.duskwoodCrypts = "標記首先要進入哪個地下室的地圖圖釘。\n\n在第一個地下室左轉。點擊 Dusty\n"
			.."Coffer 並抓取 Decrepit Phylactery。離開\n\n在第二個地下室右轉進入王座\n"
			.."房間。對沉睡的骨頭使用護身符。\n\n你剛剛喚醒了一個 25 級的巫妖。戰利品！"
st.frozen = "部落前往剃刀嶺以東的冰凍荒土\n或提瑞斯法林地亮水湖西北部的冰凍魚人\n"
			.."聯盟也在尋找冰凍的魚人，在\n"
			.."艾爾文森林的石碑湖或他們會去\n"
			.."丹莫洛的戈爾巴爾採石場的冰凍巨魔。\n\n"
			.."這些需要解凍，你需要幫助\n應用足夠的火焰減益效果"
st.grizzby = "棘齒城的 Grizzby 在 20 級以上有三個任務。\n然後你可以購買符文。\n\n"
			.."第一個任務將您送到石爪山脈。\n掉落率約為 2/3，或灰谷 (A)。\n\n"
			.."前往濕地完成第二個任務。\n\n最後的任務是魚油。可從各地獲得\n"
			.."艾澤拉斯。我標記了費伍德森林、悲傷沼澤，\n荒蕪之地和荊棘谷。全部超過 40%\n"
			.."掉落。或者如果你很有錢，那就交易或拍賣行！"
st.livAndStuart = "斯圖爾特通常站在樓梯腳下。說話\n先到莉芙·布拉德福德，如果你還沒有這樣做的話。\n"
			.."快速重生。兩者都在無名旅館"
st.secretCoven = "在“秘密”術士聚會中 \n被屠殺的羔羊的地下室"
st.starterZoneClass = "所有地點都在您的起始區域，\n來自您的職業訓練師。你不可能錯過它！\n"
			.."目標也標記好了。"
st.supplyFaction = "與艾澤拉斯商業建立友好關係\n管理局 (A) 或杜洛塔供應和\n"
			.."物流 (H)。您現在可以購買\n符文！\n\n（任務需要 8/9 級）"
st.woundedAdventurer = "前往灰熊巢穴，丹莫洛；山東\n傑羅德的登陸點，艾爾文森林；以東\n"
			.."神諭林地，泰達希爾 (A)\n\n通過風險投資公司北出口的窗台。\n礦山，莫高雷；科卡爾峭壁，森金以西\n"
			.."村莊，杜洛塔\n\n點擊骨架。另一個人\n點擊召喚傳送門。\n\n"
			.."點擊靈魂獲取戰利品"
st.zixil = "他擁有最廣泛的清單\n艾澤拉斯所有限量商品。\n最好現在就囤貨！"
...
-- Common Phase 2
st.amaryllis = "首先前往悲傷沼澤的 Amaryllis Webb\n在那裡你將購買一個昆蟲學入門套件，50s。\n\n"
			.."按任意順序捕捉一隻樹棲狼蛛，東邊和\n荊棘谷納茲費瑞提湖伐木場東南；乾草象鼻蟲來自穀倉或\n阿拉希高地的馬厩；一個肉食者來自\n"
			.."荒蕪之地科多獸骨骼墓地。\n\n返回 Amaryllis 獲取 phat lewt"
st.dalaranAgent = "前往逆風小徑的阿里登營地。它是\n靠近悲傷沼澤小路。\n\n"
			.."與達拉然特工交談並獲得\n阿里登的印記來自她。裝備它。你必須\n"
			.."現在找到並殺死 7 個黑暗騎士 (L 41)\n並掠奪他們的遺物。\n\n"
			.."當一個\n黑暗騎士就在附近。\n\n"
			.."區域有：阿拉希高地、荒蕪之地\n逆風小徑、荒蕪之地、暮色森林、沼澤\n"
			.."悲傷和貧瘠之地。\n\n完成後，返回達拉然特工並\n"
			.."交出每個“任務”。最後一個任務將\n用叢林之王符文獎勵你。\n\n"
...
st.dalaranSpeakTo = "與逆風小徑阿里登營地的達拉然特工交談"
st.dalaranQuest = { 80098, 80147, 80148, 80149, 80150, 80151, 80152, 80120 }
st.dalaranQuestName = { st.dalaranRelic .."奇怪)", st.dalaranRelic .."閃閃發光)",
						st.dalaranRelic .."呼呼)", st.dalaranRelic .."奇怪)", 
						st.dalaranRelic .."重的)", st.dalaranRelic .."令人毛骨悚然)", 
						st.dalaranRelic .."滑)", "為達拉然服務" }
st.dungeonDrops = "從剃刀高地、奧達曼、血色修道院（所有側翼）的所有 Boss 掉落"					
st.pillaged = "找到被洗劫的篝火，西北\n科多獸墓地。接受任務\n"
			.."然後去 Bibbly F'utzbuckle，他在附近\n科梅克的小屋。他會給你“在逃”\n完成。\n\n"
			.."提示將您發送到藏寶海灣的 Tokal\n在鹹水水手酒館酒吧。她會\n"
			.."讓你完成“櫻桃為你而生”。\n"
			.."從酒保那裡買櫻桃格羅格，然後\n拿起“盜賊無榮”。\n\n"
			.."你需要去通往\n從阿拉希高地到濕地。穿過\n"
			.."附近的小繩橋，走到\n水。登上小船（點擊它）。\n\n"
			.."你被傳送到了遙遠的東部\n岸。與 40 級的 Illari Duskfeather 交談。\n"
			.."她會逃跑/被殺，留下一個掉落的\n包含她戰利品箱鑰匙的小袋。\n"
			.."拿著鑲滿寶石的盒子打開它\n接收你的符文！"
-- Common Phase 3
st.enragedVoidWalker = "從 Wastewander 農場獲取編碼術士筆記\n暗影法師和 Wastewander 密碼來自\n"
			.."荒原小偷。加基森東南。\n\n組合 -> 解密的術士筆記。繼續\n"
			.."附近的召喚神秘捲軸並使用\n筆記。粉碎憤怒的虛空行者 (L43e)\n"
			.."並掠奪勝利！\n\n如果組隊，則只有一個人需要擁有\n這兩件物品，可以在拍賣行買到。\n\n"
			.."牧師和薩滿都需要這個，所以不要\n驚訝地在那裡看到另一個班級"
st.enragedVoidWalkerStart = "塔納利斯加基森東南方向是您將要耕種的地方\n荒原暴徒。稍後，出現 L43e"
st.felPortals = "\n惡魔傳送門：灰谷、黑海岸、荒蕪之地、赤脊山脈、銀松森林、悲傷沼澤、貧瘠之地、西部荒野。"
st.getCGM = "\n地點太多。使用 Taraezor 的插件“箱子、裝備等等”來查找所有已知地點，\n還有其他很酷的東西！"
...
st.emeraldWardens = "可從灰谷、暮色森林的翡翠看守軍需官處購買，\n"
			.."費伍德森林、內陸。通過相同區域的傳送門通過小組/單人任務獲得聲望。"
st.nightmareIncursions = "暮色森林：23 級以上，灰谷：37 級以上，費伍德森林：47 級以上，內陸：47 級以上\n\n"
			.."前往標記的位置並與戰地隊長交談。\n完成任務後，需要擊敗\n"
			.."傳送門附近的惡魔生物以及說話\n給一個特工，你將進入傳送門\n"
			.."完成各種挑戰。所有這些獎勵\n翡翠看守者的聲譽。\n\n"
			.."這些任務最多可以與四個人共享。它是\n強烈建議組隊並分享任務。因此，\n"
			.."小組將同時完成多項任務。\n\n"
st.leylineGuide = "參觀艾薩拉、費伍德森林中的四個地脈匯聚點，\n內陸和灼熱峽谷。\n\n"
			.."使用術士的世界核心碎片（來自小鬼\n探索）或法師的地占學捲軸。\n\n"
			.."將會生成一個憤怒的地脈行者 (L47e)。免疫奧術\n傷害。它會掉落一個地脈水晶。結合所有四個。瞧！\n\n"
			.."聖騎士/牧師必須組隊才能做到這一點"
st.leylineSummary = "在艾薩拉、費伍德森林、內陸和灼熱峽谷，您必須“協調”地脈\n"
					.."使用地占學捲軸（法師破譯）或世界核心碎片（術士小鬼探索）"
st.leylineSummaryExtra = "。\n聖騎士和牧師必須與一個或多個法師/術士組隊"
st.wildGods = "找到暗牙使者@翡翠\n聖殿，費伍德森林南部。接受“荒野之神”。\n\n"
			.."殺死 Vilebranch 暴徒 (L45e-51e) @ Jinth'Alor，南-\n東內陸，以獲得荒野低語草稿。\n\n"
			.."在剃刀沼澤（貧瘠之地最南端），進行全面清理\n最後的老闆。喝下草稿。與\n"
			.."阿迦瑪伽的靈魂並交出/拿起第 1 部分和第 2 部分\n“荒野之神”。你將收到阿迦瑪伽的怒吼。\n\n"
			.."現在前往這些地牢之一。當殺戮\n條件已滿足，您將收到一條消息\n"
			.."“你感覺到一股陰影的存在”。去一個新\n生成的幽靈野獸並使用你的阿迦瑪伽的怒吼。\n"
			.."這將召喚一個瘋狂的古代人 (L52e)。殺死並掠奪。\n你將收到 1 個野生祭品。當你有三個時，\n"
			.."回到暗牙使者處尋找你的符文。\n\n"
			..colourHighlight .."黑石深淵：" ..colourPlaintext .."擊敗格爾斯坦、格雷布瑪和\n"
			.."法律之環。前往高速公路追捕並\n對著幽靈般的蛇頸龍吹響你的號角。\n\n"
			..colourHighlight .."瑪拉頓：" ..colourPlaintext .."任意三個老闆。當你收到消息時，\n"
			.."去找塞拉德拉斯公主。附近有一隻幽靈迅猛龍。\n\n"
			..colourHighlight .."祖爾法拉克：" ..colourPlaintext .."除加茲瑞拉之外的任意三個老闆。\n"
			.."在水池區尋找一隻幽靈蜘蛛。"
st.wildGodsSpells = { "Improved Frenzied Regeneration", "Lock and Load", "Advanced Warding",
				...
				"Sword and Board" }
st.wildGodsStart = "首先與費伍德森林南部翡翠聖殿的暗牙使者交談"
...
st.dungeonSummary = "從血色修道院、剃刀高地和奧達曼的精英/首領掉落"
st.supplyFactionStart = "暴風城的伊萊恩·康普頓，“艾澤拉斯商業管理局供應商”(A),\n"
			.."奧格瑞瑪的喬納，“杜洛塔供應和物流供應商”(H)"
