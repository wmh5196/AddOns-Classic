    ...
    function(self, event, arg1, ...)
        if event == "PLAYER_LOGIN" then
            if not OptionsPanelFrame.optionsPanel then
				...
				local category = Settings.RegisterCanvasLayoutCategory(OptionsPanelFrame.optionsPanel, OptionsPanelFrame.optionsPanel.name)
				category.ID = OptionsPanelFrame.optionsPanel.name
