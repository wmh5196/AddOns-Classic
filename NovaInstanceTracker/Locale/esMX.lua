local L = LibStub("AceLocale-3.0"):NewLocale("NovaInstanceTracker", "esMX");
if (not L) then
	return;
end
...
L["instanceStatsHeaderDesc"] = "Salida de estadísticas al final del calabozo";

L["instanceStatsTextDesc"] = "Selecciona aquí qué estadísticas mostrar en el chat del grupo o en tu ventana de chat al salir de un calabozo.";

L["instanceStatsOutputTitle"] = "Estadísticas";
L["instanceStatsOutputDesc"] = "¿Muestra estadísticas sobre el calabozo al salir?";
...
L["instanceStatsOutputMobCountDesc"] = "¿Muestra cuántos enemigos fueron matados dentro del calabozo?";

L["instanceStatsOutputXPTitle"] = "Experiencia";
L["instanceStatsOutputXPDesc"] = "¿Muestra cuánta experiencia se obtuvo dentro del calabozo?";

L["instanceStatsOutputAverageXPTitle"] = "Experiencia promedio";
L["instanceStatsOutputAverageXPDesc"] = "¿Muestra la experiencia promedio por muerte dentro del calabozo?";

L["instanceStatsOutputTimeTitle"] = "Tiempo";
L["instanceStatsOutputTimeDesc"] = "¿Muestra cuánto tiempo pasaste dentro del calabozo?";

L["instanceStatsOutputGoldTitle"] = "Oro obtenido";
L["instanceStatsOutputGoldDesc"] = "¿Muestra cuánto oro se obtuvo de los enemigos dentro del calabozo?";

L["instanceStatsOutputAverageGroupLevelTitle"] = "Nivel promedio";
L["instanceStatsOutputAverageGroupLevelDesc"] = "¿Muestra el nivel promedio del grupo dentro del calabozo?";
...
L["statsOnlyWhenActivityDesc"] = "¿Muestra estadísticas solo cuando ocurrió alguna actividad dentro del calabozo? Esto significa solo si eliminaste algunos enemigos, obtuviste experiencia, saqueaste oro, etc. Esto hará que no se muestren estadísticas vacías.";
...
L["instanceStatsOutputRepDesc"] = "¿Muestra cuánta reputación se ganó mientras se está dentro del calabozo?";
...
L["instanceStatsOutputXpPerHourDesc"] = "¿Muestra cuánta experiencia por hora se ganó mientras se está dentro del calabozo?";
...
L["autoGammaBuffDesc"] = "Obtén automáticamente el beneficio gamma adecuado para tu clase cuando hables con el PNJ de gamma en un calabozo gamma.";

L["autoGammaBuffReminderTitle"] = "Recordatorio de beneficio gamma";
L["autoGammaBuffReminderDesc"] = "Imprime un mensaje en el chat al inicio del calabozo recordándote obtener el beneficio si no lo tienes.";
...
L["dungeonPopTimerTitle"] = "Temporizador de aparición de calabozo";
L["dungeonPopTimerDesc"] = "Muestra un temporizador en la ventana de cola del calabozo que indica cuánto tiempo queda para hacer clic en entrar.";
...
L["autoGammaBuffReminder"] = "Obtén el beneficio de calabozo gamma de %s.";
...
L["Instance"] = "Estancia";
L["ZoneID"] = "ID de zona";
L["Show dungeons and raids?"] = "¿Muestra calabozos y bandas?";
...
L["Current Dungeon Stats"] = "Estadísticas actuales de calabozo";
